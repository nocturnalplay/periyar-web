...
const submenu_list = [
    ...
    [{ value: "2022 Regulations", link: "/Ph.D.-r-2022.pdf" }, { value: "2017 Regulations", link: "/Ph.D.-r-2017.pdf" }],
    [{ value: "2022 Regulations", link: "/DSc-D.Litt-r-2022.pdf" }, { value: "2018 Regulations", link: "/DSc-D.Litt-r-2018.pdf" }],
]
    ...
    return (
        <div className="regulation" id="regulation">
            <menu className="regulation-menu">
                {
                    menu_list.map((a, i) => (
                        <span key={a} className={`span ${spanlist == i ? "active" : ""}`} onClick={() => menu_change(i)}>{a}</span>
                    ))
                }
            </menu>
                    ...
                    <ul className="regulation-content-list">
                        {
                            submenu_list.map((a, i) => {
                                if (spanlist === i) {
                                    return a.map(e => <li key={e.link}><Link href={e.link} target="_blank">{e.value}</Link></li>)
                                }
                            })
                        }
                    </ul>
